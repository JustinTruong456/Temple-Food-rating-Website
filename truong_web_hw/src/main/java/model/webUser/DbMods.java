...
public class DbMods {
    public static StringData getUser(DbConn dbc, String userEmail, String userPassword) {

        StringData sd = new StringData();

        if (userEmail == null) {
            sd.errorMsg = "Cannot getUser (userEmail): userEmail is null";
            return sd;
        }

        if (userPassword == null) {
            sd.errorMsg = "Cannot getUser (userPassword): userPassword is null";
            return sd;
        }
